...
*/
AlternativeName::AlternativeName(in string email_addr,
											in string uri,
											in string dns,
											in string ip)
{
...
*/
void AlternativeName::add_attribute(in string type,
												in string str)
{
	if(type == "" || str == "")
		return;
...
*/
std::multimap<string, string> AlternativeName::get_attributes() const
{
	return alt_info;
}
...
*/
std::multimap<string, string> AlternativeName::contents() const
{
