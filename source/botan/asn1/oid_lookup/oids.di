...
*/
BOTAN_DLL void add_oid(const OID& oid, in string name);

BOTAN_DLL void add_oid2str(const OID& oid, in string name);
BOTAN_DLL void add_str2oid(const OID& oid, in string name);
...
*/
BOTAN_DLL bool have_oid(in string oid);
...
*/
BOTAN_DLL string lookup(const OID& oid);
...
*/
BOTAN_DLL OID lookup(in string name);
...
*/
BOTAN_DLL bool name_of(const OID& oid, in string name);
