...
*/
module botan.block.aes_ssse3.aes_ssse3;
...
smeared = _mm_xor_si128(smeared, _mm_xor_si128(_mm_slli_si128(smeared, 8), _mm_set1_epi8(0x5B)));
	...
	return _mm_xor_si128(_mm_shuffle_epi8(sb1u, t5),
               _mm_xor_si128(_mm_shuffle_epi8(sb1t, t6),
	               smeared));
}
...
__m128i aes_ssse3_encrypt(__m128i B, const __m128i* keys, size_t rounds)
{
	...
	for (size_t r = 1; ; ++r)
	{
		...
		{
			B = _mm_shuffle_epi8(
				_mm_xor_si128(_mm_shuffle_epi8(sbou, t5),
		        _mm_xor_si128(_mm_shuffle_epi8(sbot, t6),
			        K),
				sr[r % 4]));
		...
		__m128i t7 = _mm_xor_si128(_mm_shuffle_epi8(sb1t, t6),
	                     _mm_xor_si128( _mm_shuffle_epi8(sb1u, t5),
		                     K));
		...
		B = _mm_xor_si128(_mm_shuffle_epi8(t8, mc_forward[r % 4]),
	            _mm_xor_si128(_mm_shuffle_epi8(t7, mc_backward[r % 4]),
		            t8));
	}
}
...
__m128i aes_ssse3_decrypt(__m128i B, const __m128i* keys, size_t rounds)
{
	...
	B = _mm_xor_si128(t,_mm_xor_si128( _mm_loadu_si128(keys),
	...
	for (size_t r = 1; ; ++r)
	{
		...
		__m128i t9 = _mm_xor_si128(_mm_shuffle_epi8(t8, mc),
	                     _mm_xor_si128(_mm_shuffle_epi8(sbdu, t5),
