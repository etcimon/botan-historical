...
{
	try {
		SafeArray!byte decrypted = m_op->decrypt(msg, length);
		if(m_eme)
...
*/
bool PK_Signer::self_test_signature(in Array!byte msg,
												 ...
												 const byte sig[], size_t sig_len)
{
	...
	{
		SafeArray!byte output_of_key = m_op->verify_mr(sig, sig_len);
